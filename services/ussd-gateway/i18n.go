...
var promptPacks = map[Lang]map[string]Prompt{
	...
	LangYO: {
		...
		"psm_pay_done":      {Text: "A gba N{{levy_naira}} (ref {{pssp_ref}}).\nIwe-ẹri: {{cert_serial}}\nSMS yoo tele. Ṣayẹwo: /v1/certificates/verify/{{cert_serial}}"},
